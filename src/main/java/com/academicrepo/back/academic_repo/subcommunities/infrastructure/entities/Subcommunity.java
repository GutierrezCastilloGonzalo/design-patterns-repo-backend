package com.academicrepo.back.academic_repo.subcommunities.infrastructure.entities;
...
@Entity
@Table(name = "subcommunities")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
@SuperBuilder(toBuilder = true)
public class Subcommunity extends BaseAbstractEntity {
